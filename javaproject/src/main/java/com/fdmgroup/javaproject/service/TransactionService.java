...
/**
 * TransactionService is responsible for all methods related to manipulating the Transaction entity in the database.
 * 
 * @author May Lwin
 */
@Service
public class TransactionService {
	 ...
	 * 
	 * @param transaction
	 * @return true if transaction has been created, false if transaction already exists in database
	 */
