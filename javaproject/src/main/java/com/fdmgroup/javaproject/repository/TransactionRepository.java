...
public interface TransactionRepository extends JpaRepository<Transaction, Integer> {
	...
	List<Transaction> findByUserAndDateBetweenAndType(@Param("user") User user, @Param("startDate") LocalDate startDate,
			@Param("endDate") LocalDate endDate, @Param("type") String type);
