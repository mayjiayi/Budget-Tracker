...
public class Budget {
	...
	// constructors
	public Budget(LocalDate startDate, LocalDate endDate, double targetAmount, User user, Category category) {
		super();
	...
	/**
	 * Updates budget's name, startDate, endDate, targetAmount, actualSpending,
	 * User, and Category
	 * 
	 * @param updatedBudget budget object with the same budgetId but with updated
	 *                      attributes.
	 */
